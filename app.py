...
def results():
    ...
    if query_type == 'duration':
        ...
        return render_template('results.html', query_type=query_type, total_duration=total_duration)
        ...
        if not filtered_playlists:
            return render_template('results.html', query_type=query_type, playlists=[], message='No playlists found matching the criteria.')
        ...
        for playlist_id in filtered_playlists:
            ...
            playlist_likes_views_info.append({'playlist_id': playlist_id, 'top_videos': top_videos, 'average_ratio': average_ratio, 'duration': duration})
        ...
        return render_template('results.html', query_type=query_type, playlists=playlists_data)
